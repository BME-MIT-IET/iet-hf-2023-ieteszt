			...
			switch (command[0]) {
				...
				case "list":
					if (command.length == 1) {
						...
						for (int i = 0; i < fields.size(); i++) {
							if (fields.get(i).getClass() == Refuge.class) {
						...
						for (int i = 0; i < virologists.size(); i++) {
							...
							for (int j = 0; j < mat.size(); j++) {
								if (mat.get(j).getClass() == Nucleotid.class)
									nukleotids.add(((Nucleotid) mat.get(j)).getId());
								if (mat.get(j).getClass() == AminoAcid.class)
									aminoacid.add(((AminoAcid) mat.get(j)).getId());
							}
						}
						for (int i = 0; i < fields.size(); i++) {
							if (fields.get(i) instanceof Storage) {
								List<Material> mat = ((Storage) fields.get(i)).mat;
								for (int j = 0; j < mat.size(); j++) {
									if (mat.get(j) instanceof Nucleotid)
										nukleotids.add(((Nucleotid) mat.get(j)).getId());
									if (mat.get(j) instanceof AminoAcid)
										aminoacid.add(((AminoAcid) mat.get(j)).getId());
								}
							}
						}
						...
						for (int i = 0; i < fields.size(); i++) {
							if (fields.get(i) instanceof Refuge) {
								Gear gear = ((Refuge) fields.get(i)).getGear();
								if (gear != null)
									gearek.add(gear.getid());
							}
				...
				case "code":
					...
					if (ag2 != null) {
						...
						c.setid(command[1]);
						for (int i = 0; i < virologists.size(); i++) {
							if (virologists.get(i).getid().equals(command[3]))
								virologists.get(i).Touch(c);
							;
						}
					}
					break;
				...
				case "turn":// nemworks
					if (command.length == 1) {
						int jelenleg = 0;
						for (int i = 0; i < virologists.size(); i++) {
							if (virologists.get(i).equals(main))
								jelenleg = i;
						}
						if (jelenleg == virologists.size() - 1)
							jelenleg = 0;
						else
							jelenleg++;
				...
				case "virologist":
					if (command.length == 2) {
						...
						if (virologists.size() == 1)
							main = virologists.get(virologists.size() - 1);
					...
					for (int i = 0; i < virologists.size(); i++) {// cape axe glove backpack
						if (virologists.get(i).id.equals(command[4])) {
							...
							if (command[2].equals("Cape")) {
								...
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).id = command[1];
								virologists.get(i).AddEffect(((Cape) virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1)).getCe());
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).setid("c1");
							}
							if (command[2].equals("Axe")) {
								...
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).id = command[1];
								virologists.get(i)
										.AddEffect(((Axe) virologists.get(i).getinventory().GetGears()
												.get(virologists.get(i).getinventory().GetGears().size() - 1))
												.GetEffect());
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).setid("a1");
							...
							if (command[2].equals("Glove")) {
								...
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).id = command[1];
								virologists.get(i).AddEffect(((Glove) virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1)).getGe());
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).setid("g1");
							...
							if (command[2].equals("BackPack")) {
								...
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).id = command[1];
								virologists.get(i)
										.AddEffect(((BackPack) virologists.get(i).getinventory().GetGears()
												.get(virologists.get(i).getinventory().GetGears().size() - 1))
												.getPbe());
								virologists.get(i).getinventory().GetGears()
										.get(virologists.get(i).getinventory().GetGears().size() - 1).setid("b1");
							}
					...
					for (int i = 0; i < fields.size(); i++) {
						for (int x = 0; x < fields.size(); x++)
							for (int j = 0; j < command.length; j++)
								if (fields.get(i).getid().equals(command[1])
										&& fields.get(x).getid().equals(command[j])) {

									if (x != i)
										fields.get(i).addNeighbour(fields.get(x));
									if (x != i)
										fields.get(x).addNeighbour(fields.get(i));
					...
					if (command.length >= 3 && e != null) {
						for (int i = 0; i < virologists.size(); i++) {
							if (virologists.get(i).id.equals(command[3])) {
								...
								virologists.get(i).getEffect()
										.get(virologists.get(i).getEffect().size() - 1).id = command[1];
							}
						}
					}
					break;
					...
					if (command.length >= 3 && ag != null) {
						for (int i = 0; i < virologists.size(); i++) {
							if (virologists.get(i).id.equals(command[3])) {
								...
								virologists.get(i).getinventory().GetAgens()
										.get(virologists.get(i).getinventory().GetAgens().size() - 1).id = command[1];
							}
						}
					}
					break;
					...
					for (int i = 0; i < virologists.size(); i++) {
						for (int j = 0; j < virologists.get(i).getinventory().GetAgens().size(); j++) {
							if (virologists.get(i).getinventory().GetAgens().get(j).getid().equals(command[1])) {
								...
								if (virologists.get(i).getinventory().GetAgens().get(j) instanceof MemoryLossV) {
									statsall += ("MemoryLossV]");
								}
								if (virologists.get(i).getinventory().GetAgens().get(j) instanceof VitusDanceV) {
									statsall += ("VitusDanceV]");
								}
								if (virologists.get(i).getinventory().GetAgens().get(j) instanceof Vaccine) {
									statsall += ("Vaccine]");
								}
								statsall += ("\nduration:"
										+ virologists.get(i).getinventory().GetAgens().get(j).duration);
							}
						}
					}
					int cout = 0;
					for (int i = 0; i < virologists.size(); i++) {
						if (virologists.get(i).id.equals(command[1])) {
							...
							for (int j = 0; j < virologists.get(i).getcode().size(); j++) {
								...
								if (j != virologists.get(i).getcode().size() - 1)
									statsall += (", ");
							}
							statsall += ("]\n");
							// ------
							...
							for (int j = 0; j < virologists.get(i).getinventory().GetGears().size(); j++) {
								...
								if (j != virologists.get(i).getinventory().GetGears().size() - 1)
									statsall += (", ");
							}
							statsall += ("]\n");
							// ----
							...
							for (int j = 0; j < virologists.get(i).getinventory().getMaterial().size(); j++) {
								int a = virologists.get(i).getinventory().getMaterial().get(j)
										.Accept(new MaterialVisitor());
								if (a == 2) {
									if (cout != 0)
										statsall += (", ");
							...
							for (int j = 0; j < virologists.get(i).getinventory().GetAgens().size(); j++) {
								...
								if (j != virologists.get(i).getinventory().GetAgens().size() - 1)
									statsall += (", ");
							}
							statsall += ("]\n");
							...
							for (int j = 0; j < virologists.get(i).getEffect().size(); j++) {
								...
								if (j != virologists.get(i).getEffect().size() - 1)
									statsall += (", ");
							}
							statsall += ("]\n");
						}
					...
					for (int i = 0; i < fields.size(); i++) {
						if (fields.get(i).id.equals(command[1])) {
							...
							if (fields.get(i) instanceof Refuge) {
								statsall += ("refuge");
								type = 1;
							} else if (fields.get(i) instanceof Laboratory) {
								statsall += ("laboratory");
								type = 2;
							} else if (fields.get(i) instanceof Storage) {
								statsall += ("storage");
								type = 3;
							} else
								statsall += ("empty");
							...
							for (int f1 = 0; f1 < fields.get(i).getVirologist().size(); f1++) {
								...
								if (f1 != fields.get(i).getVirologist().size() - 1)
									statsall += (", ");
							}
							statsall += ("]\n");
							// ----
							...
							for (int f1 = 0; f1 < fields.get(i).getNeighbors().size(); f1++) {
								...
								if (f1 != fields.get(i).getNeighbors().size() - 1)
									statsall += (", ");
							}
							statsall += ("]\n");
						}
