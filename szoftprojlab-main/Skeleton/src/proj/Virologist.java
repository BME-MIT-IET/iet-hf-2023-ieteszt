 ...
 * A virol�gus k�pes a mez�kr�l felvenni felszerel�seket, amik hat�ssal vannak
 * r�.
 */
public class Virologist implements Steppable {
	...
	public void Touch(Code c) {
		...
		if (b < 4 && canAttack(true) == true && fields != null && fields instanceof Laboratory)
	 ...
	 * t�mad�s.
	 * Ha a t�mad�st a keszty�vel vert�k vissza, akkor a keszty� �letereje eggyel
	 * cs�kken �s
