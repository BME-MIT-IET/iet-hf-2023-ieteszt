 ...
 * Virol�guson alkalmazhat� effect, ami a Laboratroy-on l�v� megfert�z�d�ssel
 * ker�lhet a Virol�gusra.
 *
 */
public class MaciEffekt extends Effect {
	...
	/**
	 * Amikor az effecten megh�vodik a met�dus, akkor a Virol�gus megfert�z
	 * mindenkit akivel egy mez�n �ll,
